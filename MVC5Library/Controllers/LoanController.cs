...
namespace MVC5Library.Controllers
{
    ...
    public class LoanController : Controller
    {
        ...
        {
            List<SelectListItem> User = (from i in Context.TBLUser.Where(x => x.UserStatus == true).ToList()
            ...
            List<SelectListItem> Employee = (from i in Context.TBLEmployee.Where(x => x.EmployeeStatus == true).ToList()
                                             select new SelectListItem
                                             {
